...
// 3. Delegasyon ile Modal Açma (basicLightbox kullanarak)
galleryEl.addEventListener('click', (event) => {
  event.preventDefault();

  // Eğer tıklanan öğe <img> değilse, hiçbir şey yapma.
  if (event.target.nodeName !== 'IMG') return;

  const largeImageURL = event.target.dataset.source;
  
  // Opsiyonel: Konsola büyük resim URL'sini yazdır.
  console.log('Büyük resim URL:', largeImageURL);
  
  // basicLightbox ile modal pencerede büyük resmi göster.
